...
// ================= get treatment color  =================
const NORMALIZE = {'rootCanal': 'root-canal', 'Root Canal': 'root-canal'};
const getColorFromTreatment = (treatmentKey) => {
    // const key = NORMALIZE[treatmentKey] || (treatmentKey || '').toLowerCase();
    const t = TREATMENTS.find(x => x.key === treatmentKey);
    return t ? t.colour : '#FFFFFF';
};
